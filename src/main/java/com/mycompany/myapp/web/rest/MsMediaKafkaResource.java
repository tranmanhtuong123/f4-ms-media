...
@RestController
@RequestMapping("/api/ms-media-kafka")
public class MsMediaKafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger LOG = LoggerFactory.getLogger(MsMediaKafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public MsMediaKafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
